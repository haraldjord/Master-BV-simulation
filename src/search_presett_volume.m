function [h_bot] = search_presett_volume(param, min_water_density)
%SEARCH_PRESETT_VOLUME Summary of this function goes here
%   Search for presetting of outer lid, that result in bouyancy of the
...
while searching 
    ...
    h_piston_temp = find_piston_equilibrium(param, min_water_density, h_bot_temp);
